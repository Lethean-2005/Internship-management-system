...
const navSections: NavSection[] = [
  {
    ...
    roles: ['admin', 'tutor', 'supervisor', 'intern'],
    items: [
      { to: '/', labelKey: 'sidebar.dashboard', icon: LayoutDashboard, color: '#48B6E8', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
      { to: '/my-interns', labelKey: 'sidebar.myInterns', icon: GraduationCap, color: '#22c55e', roles: ['tutor'] },
      { to: '/weekly-worklogs', labelKey: 'sidebar.weeklyWorklog', icon: ClipboardList, color: '#fb923c', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
      { to: '/final-reports', labelKey: 'sidebar.finalReport', icon: FileText, color: '#ef4444', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
      { to: '/final-slides', labelKey: 'sidebar.finalSlides', icon: Presentation, color: '#8b5cf6', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
      { to: '/contact-supervisor', labelKey: 'sidebar.contactSupervisor', icon: MessageSquare, color: '#06b6d4', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
      { to: '/company-interviews', labelKey: 'sidebar.companyInterviews', icon: CalendarCheck, color: '#0d9488', roles: ['admin', 'supervisor', 'intern'] },
      { to: '/job-postings', labelKey: 'sidebar.jobPostings', icon: Briefcase, color: '#f59e0b', roles: ['admin', 'intern'] },
      { to: '/take-leave', labelKey: 'sidebar.takeLeave', icon: CalendarOff, color: '#ec4899', roles: ['admin', 'tutor', 'supervisor', 'intern'] },
    ],
  },
  {
